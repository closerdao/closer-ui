  ...
  return (
    <>
      ...
      <section className="my-6 max-w-6xl mx-auto flex flex-col gap-4">
        <Heading level={1}>
          Privacy Policy of Traditional Dream Factory
        </Heading>
        <p>
          Enseada Sonhadora operates the TraditionalDreamFactory.com website,
          which provides the SERVICE.
        </p>
        <p>
          This page is used to inform website visitors regarding our policies
          with the collection, use, and disclosure of Personal Information if
          anyone decided to use our Service, the Traditional Dream Factory
          website.
        </p>
        <p>
        ...
        <p>
          ...
          our Terms and Conditions, which is accessible at Traditional Dream
          Factory.earth, unless otherwise defined in this Privacy Policy.
        </p>

        <Heading level={3}>Information Collection and Use</Heading>
        <p>
        ...
        <Heading level={3}>Log Data</Heading>
        <p>
          ...
          computer&rsquo;s Internet Protocol (&ldquo;IP&rdquo;) address,
        ...
        <p>
          ...
          computer&rsquo;s hard drive.
        </p>
        <p>
          Our website uses these &ldquo;cookies&rdquo; to collect information
        ...
        <Heading level={3}>Service Providers</Heading>
        <p>
        ...
        <Heading level={3}>Links to Other Sites</Heading>
        <p>
        ...
        <Heading level={3}>Children&rsquo;s Privacy</Heading>
        <p>
