...
const EDNA_SPECIES = [
  {
    name: 'Iberian Water Frog',
    latin: 'Pelophylax perezi',
    taxonomy: 'Class: Amphibia, Family: Ranidae',
    desc: 'Native Iberian amphibian indicating healthy wetland habitat.',
  },
  {
    name: 'Iberian Ribbed Newt',
    latin: 'Pleurodeles waltl',
    taxonomy: 'Class: Amphibia, Family: Salamandridae',
    desc: "Europe's largest newt species, endemic to the Iberian Peninsula.",
  },
  {
    name: 'Mosquitofish',
    latin: 'Gambusia affinis',
    taxonomy: 'Class: Actinopterygii, Family: Poeciliidae',
    desc: 'Helps control mosquito larvae populations naturally.',
  },
  {
    name: 'Green Hydra',
    latin: 'Hydra viridissima',
    taxonomy: 'Class: Hydrozoa, Family: Hydridae',
    desc: 'Freshwater polyp with symbiotic algae, indicating clean water.',
  },
  {
    name: 'Diatom Algae',
    latin: 'Nitzschia palea',
    taxonomy: 'Class: Bacillariophyceae',
    desc: 'Single-celled algae forming the base of aquatic food webs.',
  },
];
  ...
  return (
    <>
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-2 sm:gap-4 max-w-5xl mx-auto">
              <div className="bg-white/60 backdrop-blur rounded-lg p-3 sm:p-4 border border-accent/20">
                <div className="text-lg sm:text-2xl font-semibold text-accent-dark">
                  25<span className="text-sm sm:text-base">ha</span>
                </div>
                <div className="text-[10px] sm:text-xs text-gray-600">
                  {t('ecology_metric_land')}
                </div>
              </div>
              <div className="bg-white/60 backdrop-blur rounded-lg p-3 sm:p-4 border border-accent/20">
                <div className="text-lg sm:text-2xl font-semibold text-accent-dark">
      ...
      <section className="py-20 bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <blockquote
              className="text-lg italic text-gray-600 border-l-4 pl-6 text-left"
              style={{ borderColor: 'rgb(77, 219, 159)' }}
            >
              {t('ecology_intro_quote')}
              <cite className="block mt-2 text-sm not-italic text-gray-500">
                — {t('ecology_intro_quote_source')}
              </cite>
            </blockquote>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6 mb-12">
            <div className="backdrop-blur rounded-xl p-4 sm:p-6 text-center">
              ...
              <div className="text-[10px] sm:text-xs mt-1 text-gray-700">
                {t('ecology_ofp_stat_species')}
              </div>
            </div>
            <div className="backdrop-blur rounded-xl p-4 sm:p-6 text-center">
              <div className="text-lg sm:text-2xl font-semibold text-gray-900">
                0.85<span className="text-sm sm:text-base">ha</span>
              </div>
              <div className="text-[10px] sm:text-xs mt-1 text-gray-700">
                {t('ecology_ofp_stat_monitored')}
              </div>
            </div>
          ...
          >
            <Heading
              level={3}
              className="mb-6 text-xl text-gray-900 text-center"
            >
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <div className="bg-white rounded-xl p-4 sm:p-6 border border-purple-200">
                <Heading
                  level={3}
                  className="mb-4 text-base sm:text-lg text-purple-900"
                >
            ...
            <div className="space-y-4">
              ...
              {EDNA_SPECIES.map((species, index) => (
                <div
                  key={index}
                  className="bg-white rounded-lg p-5 border-l-4 border-purple-400 shadow-sm"
                >
                  <Heading level={4} className="text-base text-purple-900 mb-1">
                    {species.name}
                  </Heading>
                  <p className="text-xs text-purple-600 italic mb-2">
                    {species.latin} — {species.taxonomy}
                  </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="bg-white rounded-lg p-4 border border-blue-200">
                  <div className="font-medium text-gray-900 mb-1">
                    {t('ecology_water_lake')}
                  </div>
                  <div className="text-sm text-gray-600">
                    {t('ecology_water_lake_desc')}
                  </div>
                </div>
                <div className="bg-white rounded-lg p-4 border border-blue-200">
                  <div className="font-medium text-gray-900 mb-1">
                    {t('ecology_water_biopool')}
                  </div>
                  <div className="text-sm text-gray-600">
                    {t('ecology_water_biopool_desc')}
                  </div>
                </div>
                <div className="bg-white rounded-lg p-4 border border-blue-200">
                  <div className="font-medium text-gray-900 mb-1">
                    {t('ecology_water_infiltration')}
                  </div>
                  <div className="text-sm text-gray-600">
                    {t('ecology_water_infiltration_desc')}
                  </div>
                </div>
                <div className="bg-white rounded-lg p-4 border border-blue-200">
                  <div className="font-medium text-gray-900 mb-1">
                    {t('ecology_water_swales')}
                  </div>
                  <div className="text-sm text-gray-600">
                    {t('ecology_water_swales_desc')}
                  </div>
                </div>
                <div className="bg-white rounded-lg p-4 border border-blue-200">
                  <div className="font-medium text-gray-900 mb-1">
                    {t('ecology_water_tank')}
                  </div>
                  <div className="text-sm text-gray-600">
                    {t('ecology_water_tank_desc')}
                  </div>
                </div>
                <div className="bg-white rounded-lg p-4 border border-blue-200">
                  <div className="font-medium text-gray-900 mb-1">
                    {t('ecology_water_greywater')}
                  </div>
                  <div className="text-sm text-gray-600">
                    {t('ecology_water_greywater_desc')}
                  </div>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl p-6 sm:p-8 text-center text-white">
                ...
                <div className="text-sm sm:text-base mb-2">
                  {t('ecology_water_liters')}
                </div>
                <p className="text-xs sm:text-sm text-blue-100">
                  {t('ecology_water_impact')}
                </p>
              </div>
              <div className="bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl p-4 sm:p-6 text-white">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs sm:text-sm font-medium text-cyan-100">
                    {t('ecology_water_table_title')}
                  </span>
                  <span className="text-[10px] sm:text-xs bg-white/20 px-2 py-1 rounded">
                    2024 → 2025
                  </span>
                </div>
                <div className="flex items-end justify-center gap-4 sm:gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-[10px] sm:text-xs text-cyan-200">
                      {t('ecology_water_table_before')}
                    </div>
                  </div>
                  <div className="text-base sm:text-xl mb-1">→</div>
                  <div className="text-center">
                    <div className="text-lg sm:text-2xl font-semibold text-cyan-100">
                      3m
                    </div>
                    <div className="text-[10px] sm:text-xs text-cyan-200">
                      {t('ecology_water_table_after')}
                    </div>
                  </div>
                </div>
                <p className="text-[10px] sm:text-xs text-cyan-100 mt-3 text-center">
                  {t('ecology_water_table_desc')}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <Card className="p-6 text-center">
              ...
              <Heading level={4} className="mb-2">
                {t('ecology_monitor_edna')}
              </Heading>
              <p className="text-sm text-gray-600">
                {t('ecology_monitor_edna_desc')}
              </p>
            </Card>
            <Card className="p-6 text-center">
              <Satellite className="w-8 h-8 text-blue-600 mx-auto mb-4" />
              <Heading level={4} className="mb-2">
                {t('ecology_monitor_satellite')}
              </Heading>
              <p className="text-sm text-gray-600">
                {t('ecology_monitor_satellite_desc')}
              </p>
            </Card>
            <Card className="p-6 text-center">
              <FlaskConical className="w-8 h-8 text-amber-600 mx-auto mb-4" />
              <Heading level={4} className="mb-2">
                {t('ecology_monitor_sensors')}
              </Heading>
              <p className="text-sm text-gray-600">
                {t('ecology_monitor_sensors_desc')}
              </p>
            </Card>
            <Card className="p-6 text-center">
              <Users
                className="w-8 h-8 mx-auto mb-4"
                style={{ color: 'rgb(50, 160, 120)' }}
              />
              <Heading level={4} className="mb-2">
                {t('ecology_monitor_community')}
              </Heading>
              <p className="text-sm text-gray-600">
                {t('ecology_monitor_community_desc')}
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <div
              ...
              style={{ backgroundColor: 'rgba(77, 219, 159, 0.2)' }}
            >
              <Shield
                className="w-7 h-7"
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <span
                    ...
                    style={{
                      backgroundColor: 'rgba(77, 219, 159, 0.2)',
                      color: 'rgb(77, 219, 159)',
                    }}
                  >
                    {principle.id}
                  </span>
                  <Heading level={4} className="text-white text-sm">
                    {principle.title}
                  </Heading>
                </div>
      ...
      <section
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(77, 219, 159, 0.1) 0%, rgba(77, 219, 159, 0.05) 100%)',
        }}
      >
