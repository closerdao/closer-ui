...
const ImpactMapPage = () => {
  ...
  const impactDomains: ImpactDomain[] = [
    {
      ...
      items: [
        ...
        {
          type: 'indicator',
          text: t('impact_water_indicator_1'),
          metric: t('impact_metric_monthly'),
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'indicator',
          text: t('impact_food_indicator_1'),
          metric: t('impact_metric_target_60'),
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          type: 'indicator',
          text: t('impact_land_indicator_1'),
          metric: t('impact_metric_annual'),
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'indicator',
          text: t('impact_transport_indicator_1'),
          metric: t('impact_metric_monthly'),
        },
        { type: 'action', text: t('impact_transport_action_2') },
        {
          type: 'indicator',
          text: t('impact_transport_indicator_2'),
          metric: t('impact_metric_quarterly'),
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          type: 'indicator',
          text: t('impact_waste_indicator_1'),
          metric: t('impact_metric_annual'),
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          type: 'indicator',
          text: t('impact_materials_indicator_1'),
          metric: t('impact_metric_per_project'),
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'indicator',
          text: t('impact_energy_indicator_1'),
          metric: t('impact_metric_goal_100'),
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'indicator',
          text: t('impact_health_indicator_1'),
          metric: t('impact_metric_per_booking'),
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'indicator',
          text: t('impact_community_indicator_1'),
          metric: t('impact_metric_per_vote'),
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          type: 'indicator',
          text: t('impact_equity_indicator_1'),
          metric: t('impact_metric_quarterly'),
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'indicator',
          text: t('impact_governance_indicator_1'),
          metric: t('impact_metric_continuous'),
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          type: 'indicator',
          text: t('impact_transparency_indicator_1'),
          metric: t('impact_metric_quarterly'),
        },
  ...
  const sustainabilityDomains = impactDomains.filter(
    (d) => d.category === 'sustainability',
  );
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          <header className="text-center mb-12">
            ...
            <div className="bg-accent-alt-light border border-accent-alt rounded-lg p-4 max-w-2xl mx-auto">
              <p className="text-sm text-foreground">
                <strong>{t('impact_map_note_label')}:</strong>{' '}
                {t('impact_map_note_text')}
              </p>
            </div>
          </header>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-8 mb-12">
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold uppercase tracking-wide text-sm">
                {t('impact_pillar_sustainability')}
              </span>
            </div>
            <div className="flex items-center gap-3">
              ...
              >
                <div className="bg-accent-alt-light p-4 flex items-center gap-3 border-b border-gray-200">
                  ...
                  {domain.link && (
                    <Link
                      href={domain.link}
                      className="ml-auto text-gray-400 hover:text-accent-alt transition-colors"
                    >
                ...
                <div className="p-4">
                  {domain.items.map((item, itemIdx) => (
                    <div
                      key={itemIdx}
                      className="flex gap-3 py-2 border-b border-gray-100 last:border-0 items-start"
                    >
                      <div
                        className={`w-6 h-6 rounded flex-shrink-0 flex items-center justify-center text-xs font-bold text-white ${item.type === 'action' ? 'bg-accent-alt' : 'bg-accent'}`}
                      >
          ...
          <div className="flex justify-center gap-8 py-8 border-t border-gray-200">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              <div className="w-6 h-6 rounded bg-accent-alt flex items-center justify-center text-xs font-bold text-white">
                A
              </div>
          ...
          <Heading level={2} className="text-2xl mb-6 mt-12">
            {t('impact_how_we_deliver_title')}
          </Heading>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              <div className="bg-accent-alt-light p-4 flex items-center gap-3 border-b border-gray-200">
                ...
                <span className="font-semibold text-foreground">
                  {t('impact_section_ecology_title')}
                </span>
              </div>
              <div className="p-5">
                <p className="text-sm text-gray-700 mb-4">
                  {t('impact_section_ecology_desc')}
                </p>
                <div className="grid grid-cols-3 gap-3 mb-4">
                  <div className="text-center p-2 bg-gray-50 rounded">
                    ...
                    <div className="text-xs text-gray-500">
                      {t('impact_section_ecology_birds')}
                    </div>
                  </div>
                  <div className="text-center p-2 bg-gray-50 rounded">
                    <div className="text-lg font-semibold text-foreground">
                    ...
                    <div className="text-xs text-gray-500">
                      {t('impact_section_ecology_tree_species')}
                    </div>
                  </div>
                  <div className="text-center p-2 bg-gray-50 rounded">
                    <div className="text-lg font-semibold text-foreground">
                ...
                <Link
                  href="/pages/ecology"
                  className="inline-flex items-center gap-2 text-sm text-accent-alt hover:underline font-medium"
                >
                  {t('impact_section_ecology_cta')}{' '}
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              <div className="bg-accent-alt-light p-4 flex items-center gap-3 border-b border-gray-200">
                ...
                <span className="font-semibold text-foreground">
                  {t('impact_section_agriculture_title')}
                </span>
              </div>
              <div className="p-5">
                <p className="text-sm text-gray-700 mb-4">
                  {t('impact_section_agriculture_desc')}
                </p>
                <div className="grid grid-cols-3 gap-3 mb-4">
                  <div className="text-center p-2 bg-gray-50 rounded">
                    <div className="text-lg font-semibold text-foreground">
                    ...
                    <div className="text-xs text-gray-500">
                      {t('impact_section_agriculture_trees')}
                    </div>
                  </div>
                  <div className="text-center p-2 bg-gray-50 rounded">
                    <div className="text-lg font-semibold text-foreground">
                    ...
                    <div className="text-xs text-gray-500">
                      {t('impact_section_agriculture_water')}
                    </div>
                  </div>
                  <div className="text-center p-2 bg-gray-50 rounded">
                    <div className="text-lg font-semibold text-foreground">
                    ...
                    <div className="text-xs text-gray-500">
                      {t('impact_section_agriculture_target')}
                    </div>
                  </div>
                </div>
                <ul className="text-sm text-gray-600 space-y-1 mb-4">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 text-sm text-accent-alt hover:underline font-medium"
                >
                  {t('impact_section_agriculture_cta')}{' '}
                  <ExternalLink className="w-3 h-3" />
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              <div className="bg-accent-light p-4 flex items-center gap-3 border-b border-gray-200">
                ...
                <span className="font-semibold text-foreground">
                  {t('impact_section_governance_title')}
                </span>
              </div>
              <div className="p-5">
                <p className="text-sm text-gray-700 mb-4">
                  {t('impact_section_governance_desc')}
                </p>
                <div className="grid grid-cols-3 gap-3 mb-4">
                  <div className="text-center p-2 bg-gray-50 rounded">
                    <div className="text-lg font-semibold text-foreground">
                    ...
                    <div className="text-xs text-gray-500">
                      {t('impact_section_governance_holders')}
                    </div>
                  </div>
                  <div className="text-center p-2 bg-gray-50 rounded">
                    <div className="text-lg font-semibold text-foreground">
                    ...
                    <div className="text-xs text-gray-500">
                      {t('impact_section_governance_countries')}
                    </div>
                  </div>
                  <div className="text-center p-2 bg-gray-50 rounded">
                    <div className="text-lg font-semibold text-foreground">
                    ...
                    <div className="text-xs text-gray-500">
                      {t('impact_section_governance_voting')}
                    </div>
                  </div>
                </div>
                <ul className="text-sm text-gray-600 space-y-1 mb-4">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  >
                    {t('impact_section_governance_cta')}{' '}
                    <ExternalLink className="w-3 h-3" />
                  </Link>
                  <a
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              <div className="bg-accent-light p-4 flex items-center gap-3 border-b border-gray-200">
                ...
                <span className="font-semibold text-foreground">
                  {t('impact_section_dataroom_title')}
                </span>
              </div>
              <div className="p-5">
                <p className="text-sm text-gray-700 mb-4">
                  {t('impact_section_dataroom_desc')}
                </p>
                <div className="grid grid-cols-3 gap-3 mb-4">
                  <div className="text-center p-2 bg-gray-50 rounded">
                    <div className="text-lg font-semibold text-foreground">
                    ...
                    <div className="text-xs text-gray-500">
                      {t('impact_section_dataroom_raised')}
                    </div>
                  </div>
                  <div className="text-center p-2 bg-gray-50 rounded">
                    <div className="text-lg font-semibold text-foreground">
                    ...
                    <div className="text-xs text-gray-500">
                      {t('impact_section_dataroom_reports')}
                    </div>
                  </div>
                  <div className="text-center p-2 bg-gray-50 rounded">
                    <div className="text-lg font-semibold text-foreground">
                    ...
                    <div className="text-xs text-gray-500">
                      {t('impact_section_dataroom_since')}
                    </div>
                  </div>
                </div>
                <ul className="text-sm text-gray-600 space-y-1 mb-4">
