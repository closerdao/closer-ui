...
import { NavigationLink } from 'closer/types/nav';
import api from 'closer/utils/api';
import NavLink from 'closer/components/ui/NavLink';
import Switcher from 'closer/components/ui/Switcher';
import Profile from 'closer/components/Profile';
import ReportABug from 'closer/components/ReportABug';
...
const MemberMenu: React.FC = () => {
  ...
  return (
    <nav className="flex flex-col gap-4">
      ...
      {isWalletEnabled && <ConnectWallet variant="compact" showVotingWeight={true} />}
      {navOptions.length > 1 && (
        <div className="mt-2">
          <Switcher
            options={navOptions}
