        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              {isBookingEnabled && (
                <li>
                  <Link href="/stay" className="hover:text-gray-900">
                    {t('footer_book_stay')}
                  </Link>
                </li>
              )}
              ...
              {isSubscriptionsEnabled && (
                <li>
                  <Link href="/subscriptions" className="hover:text-gray-900">
                    {t('footer_subscriptions')}
                  </Link>
                </li>
              )}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              {isTokenSaleEnabled && (
                <li>
                  <Link href="/token" className="hover:text-gray-900">
                    {t('footer_token')}
                  </Link>
                </li>
              )}
              {isWeb3Enabled && (
                <li>
                  <Link href="/airdrop" className="hover:text-gray-900">
                    {t('footer_airdrop')}
                  </Link>
                </li>
              )}
              ...
              {isCitizenshipEnabled && (
                <li>
                  <Link href="/citizenship" className="hover:text-gray-900">
                    {t('footer_citizenship')}
                  </Link>
                </li>
              )}
              <li>
                <Link href="/artists" className="hover:text-gray-900">
                  {t('footer_artists')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="font-semibold text-gray-900 mb-4">
              {t('footer_land_project')}
            </h3>
            <ul className="space-y-2 text-sm text-gray-600">
              <li>
                <Link href="/pages/ecology" className="hover:text-gray-900">
                  {t('footer_ecology')}
                </Link>
              </li>
              <li>
                <Link href="/cohousing" className="hover:text-gray-900">
                  {t('footer_cohousing')}
                </Link>
              </li>
              <li>
                ...
                >
                  {t('footer_regenerative_agriculture')}
                </Link>
              </li>
              <li>
                <Link href="/pages/restaurant" className="hover:text-gray-900">
                  {t('footer_restaurant')}
                </Link>
              </li>
              <li>
                <Link href="/fundraiser" className="hover:text-gray-900">
                  {t('footer_invest')}
                </Link>
              </li>
              <li>
                <Link href="/impact-map" className="hover:text-gray-900">
                  {t('footer_impact_map')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                <Link href="/learn-more" className="hover:text-gray-900">
                  {t('footer_learn_more')}
                </Link>
              </li>
            </ul>
