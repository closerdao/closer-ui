...
import GuestMenu from 'closer/components/GuestMenu';
import Logo from 'closer/components/Logo';
import Menu from 'closer/components/MenuContainer';
import ProfilePhoto from 'closer/components/ProfilePhoto';
          ...
          {!isAuthenticated &&
            ...
            (APP_NAME.toLowerCase() === 'moos' ||
              ...
              <Button
                ...
                variant="primary"
                className={`${
                  router.locales && router.locales.length > 1 ? 'hidden sm:block' : ''
                }`}
              >
