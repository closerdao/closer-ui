# Ambassador program — Phase 3 network epics

Lighter epics after map + Ambassador MVP and Tier 0→1 conversion. Full context: [ambassador-program-requirements.md](./ambassador-program-requirements.md).
...
- Pool villages; curated values/culture; priority access & discounts; token exchange at scale
- Ambassador program supplies the village graph + verification badges

## F11. Cross-village subscriptions (Appendix B)

- Example: €50/mo network passport with split sketch 70% villages / 15% curator / 10% Closer / 5% future fund
- Not MVP — after passport + multi-tenant billing
