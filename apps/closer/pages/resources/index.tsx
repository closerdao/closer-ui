  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="keywords"
          content={`${PLATFORM_NAME}, resources, FAQ, frequently asked questions, community resources, regenerative communities`}
        />
        <meta
          property="og:title"
        ...
        <meta
          property="og:url"
          content={`${process.env.NEXT_PUBLIC_PLATFORM_URL || 'https://closer.earth'}/resources`}
        />
        ...
        <meta
          ...
          content={`Resources and frequently asked questions about ${PLATFORM_NAME}.`}
        />
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_PLATFORM_URL || 'https://closer.earth'}/resources`}
        />
      </Head>
