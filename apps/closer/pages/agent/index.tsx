...
const AgentPage = ({}: Props) => {
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      <Head>
        <title>
          Closer Agent — Sovereign Intelligence for Regenerative Communities
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="AI agent, sovereign AI, regenerative communities, community intelligence, decentralized AI, Closer Agent"
        />
        <meta
          property="og:title"
          content="Closer Agent — Sovereign Intelligence for Regenerative Communities"
        />
        <meta
          property="og:description"
          content="Turn community knowledge into living intelligence. Closer Agent transforms your conversations, documents, and institutional memory into an AI that understands your land, your people, and your mission."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content={`${process.env.NEXT_PUBLIC_PLATFORM_URL || 'https://closer.earth'}/agent`}
        />
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_PLATFORM_URL || 'https://closer.earth'}/agent`}
        />
      </Head>
      ...
      <section className="pt-32 pb-20 px-6 md:px-[5vw]">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-serif text-5xl md:text-7xl mb-6 leading-tight">
            Turn community knowledge into{' '}
            <em className="italic">living intelligence</em>
          </h1>
          <p className="text-xl text-[#86868b] max-w-2xl mb-10 leading-relaxed">
            Closer Agent transforms your conversations, documents, and
            institutional memory into an AI that understands your land, your
            people, and your mission—running entirely on your infrastructure.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="border-t border-white/10 pt-6">
              ...
              <p className="text-[#86868b] text-sm leading-relaxed">
                Your community&apos;s knowledge never leaves your
                infrastructure. Run inference locally, train on your terms,
                maintain complete control over what the agent learns.
              </p>
            </div>
            <div className="border-t border-white/10 pt-6">
              ...
              <p className="text-[#86868b] text-sm leading-relaxed">
                Token holders decide what data enters the knowledge base, which
                behaviors the agent exhibits, and when human presence is
            ...
            <div className="border-t border-white/10 pt-6">
              ...
              <p className="text-[#86868b] text-sm leading-relaxed">
                Connect with other Closer communities to share learnings without
                exposing raw data. Knowledge flows up voluntarily, strengthening
                the network.
              </p>
            </div>
          </div>
      ...
      <section className="py-32 px-6 md:px-[5vw]">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg text-[#86868b] max-w-2xl mb-16">
            The agent comes pre-trained on ecological and regenerative domains,
            with context awareness for your specific environment.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 border border-white/10 rounded-lg hover:border-white/20 transition-colors">
              ...
              <p className="text-sm text-[#86868b] leading-relaxed">
                Watershed analysis, water quality monitoring, hydrology
                patterns, irrigation optimization
              </p>
            </div>
            <div className="p-6 border border-white/10 rounded-lg hover:border-white/20 transition-colors">
              <h4 className="font-medium text-base mb-2">Biodiversity</h4>
              <p className="text-sm text-[#86868b] leading-relaxed">
                Species conservation, ecosystem health assessment, habitat
            ...
            <div className="p-6 border border-white/10 rounded-lg hover:border-white/20 transition-colors">
              ...
              <p className="text-sm text-[#86868b] leading-relaxed">
                Policy analysis, stakeholder engagement, regulatory compliance,
            ...
            <div className="p-6 border border-white/10 rounded-lg hover:border-white/20 transition-colors">
              ...
              <p className="text-sm text-[#86868b] leading-relaxed">
                Project economics, funding strategies, ROI analysis, prospect
                pipeline management
              </p>
            </div>
          </div>
      ...
      <section className="py-32 px-6 md:px-[5vw] bg-[#1d1d1f]">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg text-[#86868b] max-w-2xl mb-16">
            A complete platform for managing knowledge, tasks, relationships,
            and collaboration.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/10 border border-white/10">
            <div className="bg-black p-10">
              ...
              <p className="text-sm text-[#86868b] leading-relaxed">
                Natural language interaction with domain expertise. Ask
                questions, get recommendations, preserve context across
                conversations.
              </p>
            </div>
            <div className="bg-black p-10">
              ...
              <p className="text-sm text-[#86868b] leading-relaxed">
                Drop in documents, audio, video, images. Automatic
                transcription, extraction, and indexing into searchable
                knowledge.
              </p>
            </div>
            <div className="bg-black p-10">
              ...
              <p className="text-sm text-[#86868b] leading-relaxed">
                Automated context generation, research findings, document
                queries, and deliverable tracking with intelligent
                prioritization.
              </p>
            </div>
            <div className="bg-black p-10">
              ...
              <p className="text-sm text-[#86868b] leading-relaxed">
                Track prospects, funders, contractors, and community members.
                Pipeline stages, contact details, and interaction history.
              </p>
            </div>
            <div className="bg-black p-10">
              <div className="w-9 h-9 mb-5 text-white">
              ...
              <p className="text-sm text-[#86868b] leading-relaxed">
                Multi-project support with complete data separation.
                Conversations, tasks, and prospects scoped to specific
                initiatives.
              </p>
            </div>
            <div className="bg-black p-10">
              ...
              <p className="text-sm text-[#86868b] leading-relaxed">
                Season, region, terrain, and rainfall awareness. Recommendations
                adapt to your specific ecological conditions.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-16">
            <div className="pb-16 border-b border-white/10">
              ...
              <p className="text-[#86868b] mb-8 max-w-2xl leading-relaxed">
                A natural language interface that understands your domain and
                remembers your context. Ask questions, get recommendations,
            ...
            <div className="pb-16 border-b border-white/10">
              ...
              <p className="text-[#86868b] mb-8 max-w-2xl leading-relaxed">
                Tasks that think. Automated context generation pulls in relevant
                research, documents, and insights so work gets done faster.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
            ...
            <div className="pb-16 border-b border-white/10">
              ...
              <p className="text-[#86868b] mb-8 max-w-2xl leading-relaxed">
                Every format your community produces becomes searchable, indexed
                knowledge. Meetings become transcripts. Documents become
                answers.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
            ...
            <div>
              ...
              <p className="text-[#86868b] mb-8 max-w-2xl leading-relaxed">
                Track every relationship that matters to your project. From
                token buyers to foundations, keep your pipeline organized and
      ...
      <section className="py-32 px-6 md:px-[5vw] bg-black">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="font-serif text-4xl md:text-5xl mb-6">
            Your data. Your hardware. Your{' '}
            <em className="italic text-[#79FAC1]">intelligence</em>.
          </h2>
          <p className="text-lg text-[#86868b] mb-12 max-w-2xl leading-relaxed">
            Traditional AI services create dependency—you rent intelligence, you
            don&apos;t own it. Models change, prices increase, access gets
            revoked. Closer Agent inverts this relationship entirely.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                title: 'Hardware you control',
                desc: 'Run on your own machines',
              },
              {
                title: 'Weights you own',
                desc: 'The model is community property',
              },
              {
                title: 'Training you direct',
                desc: 'Decide what the agent learns',
              },
              {
                title: 'Governance you define',
                desc: 'Token holders set the rules',
              },
            ].map((item) => (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-[120px_1fr] gap-8 pb-8 border-b border-white/10">
              <div>
                <div className="text-xs uppercase tracking-wider text-[#86868b] mb-1">
                  Next
                </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={item}
                      className="px-3 py-1.5 bg-[#1d1d1f] rounded text-xs text-[#86868b]"
                    >
                      {item}
                    </span>
                  ))}
      ...
      <section className="py-32 px-6 md:px-[5vw] text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-[#86868b] mb-10 max-w-xl mx-auto">
            Join the network of regenerative communities building sovereign
