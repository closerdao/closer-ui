  ...
  <Layout>
    ...
    <main className="foreground m-3">
      <section className="text-xl mb-20">
        ...
        <blockquote className="text-6xl my-8">Earth has lost 50% of its wildlife in the past 40 years <sup><a href="#footnotes">[1]</a></sup></blockquote>
        ...
        <p className="mb-4">We are here to prototype a better way. We believe that humans are kind by design <sup><a href="#footnotes">[2]</a></sup>, and are commited to promoting <b>biodiversity, restauration of water cycles, regeneration of the soils, and regeneration of souls</b>.</p>
        ...
        <p className="mb-4">This is not idealism or optimism. We are realists, and it is time that our modern societies wake up to the call. A new Earth is waiting. In this new planet, <b>we are the stewards of our spaceship</b>. In this new world, we thrive by promoting biodiversity and being in the service of the greater ecosystem that we are a part of. We must re:learn to be part of Nature, and to respect its delicate cycles.</p>
