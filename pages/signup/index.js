  ...
  return (
    <Layout>
      ...
      <main className="main-content">
        ...
        <p className="mb-8">
          The process starts with you filling this form. Once you press the <a className="text-pink-500" href="#signupbutton">pink button</a> our community curator will receive your words and connect with you for a short call.
        </p>
        <p className="mb-8">
        ...
        { submitted?
          ...
          <form className="join mt-24 flex flex-col" onSubmit={ submit }>
            ...
            <button id="signupbutton" className="button px-4 py-1 mr-2 mb-2 rounded-full hover:bg-black bg-pink-500 text-white text-xl font-bold" type="submit">Apply</button>
          </form>
        }
      </main>
    </Layout>
