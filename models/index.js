...
- Plant seeds` },
  ...
  listing: [
    ...
    { name: 'fiatPrice', label: 'Rental rate', type: 'currency', placeholder: '10.00', required: true, tab: 'prices' },
    { name: 'tokenPrice', label: 'Weekly rate', type: 'cryptoCurrency', placeholder: '10.00', required: true, tab: 'prices' },
