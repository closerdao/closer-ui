 ...
 * never matches, so the "needs an event list" effect below was firing a real
 * (and always-failing) XHR to the placeholder API host. Mock the `.js` path
 * directly, the same way settingsAutosave.test.tsx does.
 */
