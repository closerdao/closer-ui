...
export const AppHead: FC = () => {
  ...
  const defaultDescription =
    'The operating system for regenerative communities. Manage guests, spaces, events and resources through one intuitive platform designed specifically for land-based projects.';
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="regenerative communities, community management, booking system, event management, DAO, decentralized governance, ecovillage, intentional community"
        />
