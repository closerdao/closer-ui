...
const FUTURE_ACCOMMODATION_TYPES = [
  { name: `${__('token_sale_public_sale_shared_suite')} (${__('generic_coming_soon')})`, price: 1 },
  { name: `${__('token_sale_public_sale_private_suite')} (${__('generic_coming_soon')})`, price: 2 },
  { name: `${__('token_sale_public_sale_studio')} (${__('generic_coming_soon')})`, price: 3 },
  { name: `${__('token_sale_public_sale_house')} (${__('generic_coming_soon')})`, price: 5 },
];
