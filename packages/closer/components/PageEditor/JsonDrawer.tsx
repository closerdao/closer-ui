...
const JsonDrawer = ({ open, onClose, payload }: Props) => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 max-w-[min(420px,calc(100vw-2rem))] w-full max-h-60 overflow-auto rounded-lg bg-gray-900 text-gray-100 text-xs font-mono p-4 shadow-lg">
