...
const staticVillages = [
  {
    ...
    coords: [38.00315852735004, -8.559098061601965],
  },
  {
    name: 'The Garden',
    description:
      'Living research institute and creative cauldron in northern Portugal near Viana do Castelo. Coliving space for artists, hackers, and world builders exploring new ways of cohabitation, coordination, and creation. Hosts residencies, workshops, and events.',
  ...
  },
  {
    name: 'Freedom Ville',
    description:
      'Eco resort and boutique hotel in restored abandoned village of Malhadil, Vale da Certa. 14 hectares with 17 unique accommodations including yurts, tiny houses, apartments. Hosts retreats, artist residencies, and community events.',
    tags: [
      'Eco Village',
      'Eco Resort',
      'Artist Residency',
  ...
  },
  {
    name: 'SilveiraTech',
    description:
      'Regeneration village in Serra da Lousã revitalizing two abandoned mountain villages and 230 hectares of forest. Global community hub bridging innovation and regeneration with focus on transformative education, disruptive tech, and ecological restoration.',
    tags: [
      'Eco Village',
      'Regenerative',
      'Tech Hub',
  ...
  },
  {
    ...
    coords: [52.37939610539903, -120.10482691195828],
  },
  {
    name: 'Nuanu',
    description: 'A regenerative village reimagining community living.',
    tags: ['Coliving', 'Eco Village', 'Education'],
    country: 'Portugal',
  ...
  },
  {
    name: 'Brave Earth',
    description:
      'At Brave Earth we are in an inquiry about how to adapt and create more resiliency.',
    tags: ['Eco Village', 'Resort'],
    country: 'Costa Rica',
    website: 'https://www.braveearth.com/',
    coords: [10.387039654490446, -84.59900518946831],
  },
  {
    name: 'Feytopia',
    description:
      'A collective of artists, entrepreneurs, activists, academics and technologists.',
    tags: ['Art', 'Coliving', 'Event Space', 'Maker Space'],
    country: 'France',
    website: 'https://feytopia.com/',
    coords: [48.014520013900935, 3.330757256138603],
  },
  {
    name: 'Embassy Network',
    description:
      'Global network of intentional co-living spaces experimenting with governance, culture, and commoning.',
  ...
  },
  {
    ...
    description:
      'French intentional community focused on sustainable living and permaculture.',
  ...
  },
  {
    name: 'Cabin',
    description:
      'Network city connecting creators building neighborhoods in nature.',
  ...
  },
  {
    ...
    description:
      'International community and hotel in magic forest near Lagodekhi, Georgia. Founded 2019 by Ivan Mitin (Ziferblat founder) on 12 hectares with tiny houses, A-frames, circus tents, organic farm, and communal living. Family-friendly co-living space.',
    tags: [
      'Co-living',
      'Community',
      'Hotel',
  ...
  },
  {
    name: 'Commons Hub',
    description:
      'Communal guesthouse and events venue in Austrian Alps at historic Hirschwangerhof near Reichenau an der Rax, one hour south of Vienna. Harbor for artists, hackers, and thinkers exploring commons, web3, and regenerative systems. Accommodates 30 overnight guests.',
    tags: [
      'Co-working',
      'Events',
      'Community',
  ...
  },
  {
    ...
    tags: ['Coliving', 'Event Space', 'Education'],
    country: 'USA',
  ...
  },
  {
    ...
    tags: ['Eco Village', 'Event Space', 'Farming'],
    country: 'Portugal',
    website: 'https://www.tamera.org/',
    coords: [37.719164253904665, -8.520731891604433],
  },
  {
    name: 'Findhorn',
    description:
      'Creating a radically transformed world where humanity embodies the Sacred.',
    tags: ['Eco Village', 'Farming'],
    country: 'Scotland',
    website: 'https://www.findhorn.org/',
    coords: [57.65910431271089, -3.607543109005856],
  },
  {
    name: 'Damanhur',
    description:
      'A Federation of Communities and Eco-society based on ethical and spiritual values.',
    tags: ['Eco Village', 'Education', 'Event Space'],
    country: 'Italy',
  ...
  },
  {
    name: 'Ängsbacka',
    description:
      'Ängsbacka is more than a venue for courses, festivals and volunteer programs.',
    tags: ['Eco Village', 'Education', 'Event Space', 'Farming'],
    country: 'Sweden',
    website: 'https://www.angsbacka.com/',
    coords: [59.60160478264089, 13.700197092607924],
  },
  {
  ...
  },
  {
    name: 'Auroville',
    description:
      'An experimental township in India founded with the aim of realizing human unity.',
    tags: ['Eco Village', 'Education', 'Event Space'],
    country: 'India',
  ...
  },
  {
    name: 'Amagi Village',
    description:
      'Family-friendly eco-village in development on Koh Phangan, Thailand. Invite-only creative village for entrepreneurs, artists, and creators blending technology, nature, and wellness.',
    tags: [
      'Eco Village',
      'Co-living',
      'Entrepreneurship',
  ...
  },
  {
    ...
    description:
      'Global community and transformational festival founded by Wild Sirenda (DJ duo). 5-day events combining music, art, ceremony, wellness, and dream activation. Held at Baba Beach Club, Phuket with yoga, workshops, electronic music, and conscious celebration.',
    tags: [
      'Events',
      'Music',
      'Wellness',
  ...
  },
  {
    ...
    description:
      'Member-driven association in Eksjö, Sweden rooted in burner culture principles. 100-hectare farm with building restoration, agriculture, cultural projects, and monthly work weekends. Historic estate dating to 1500s surrounded by nature reserve.',
    tags: [
      'Community',
      'Burner Culture',
      'Co-creation',
  ...
  },
  {
    name: 'Gandum Village',
    description:
      'Conscious boutique hotel in Alentejo with regenerative agriculture, rammed earth construction, coworking spaces, and sustainable living practices on 14 hectares.',
  ...
  },
  {
    name: 'Villa Gaia',
    description:
      'Systems change hub in Tuscany mountains where teams live and work together. Launched 4 MVS projects in 10 months through proximity, convergence, and coordinated action.',
  ...
  },
  {
    name: 'Hedonia',
    description:
      'Berlin-based art movement and trans-local community with gatherings in Tulum, celebrating ethical hedonism, pleasure liberation, and fighting FGM through immersive events.',
  ...
  },
  {
    ...
    description:
      'A spiritual community and retreat center in the mountains of New Mexico.',
    tags: ['Eco Village', 'Education'],
    country: 'USA',
    website: 'https://www.lamafoundation.org/',
    coords: [36.635976985840024, -105.60021034161221],
  },
  {
    name: 'Gampo Abbey',
  ...
  },
  {
    name: 'Selgars Mill',
    description:
      "19th century mill estate in Devon's Culm Valley hosting nature conferences, team retreats, SOMOS immersions, weddings, and winter co-living residencies on 8 acres.",
  ...
  },
  {
    ...
    description:
      'An intentional community committed to ecological sustainability.',
    tags: ['Eco Village', 'Education', 'Farming'],
    country: 'USA',
  ...
  },
  {
    ...
    coords: [42.41965589345587, -72.42650614602519],
  },
  {
    ...
    coords: [35.52030080939994, -82.20362682883604],
  },
  {
  ...
  },
  {
    ...
    tags: ['Coliving', 'Coworking', 'Event Space'],
    country: 'USA',
  ...
  },
  {
    ...
    coords: [-40.81153448401491, 172.95760384146763],
  },
  {
    name: 'Liminal Village',
    description:
      'A community dedicated to alternative lifestyles and sustainable living.',
    tags: ['Coliving', 'Eco Village', 'Education', 'Farming'],
    country: 'Italy',
    website: 'https://liminalvillage.com/',
    coords: [42.5273002663103, 13.078969460849983],
  },
  {
    name: 'Zunya',
    description: 'A space to reconnect with yourself, nature, and others.',
    tags: ['Eco Village', 'Education', 'Event Space', 'Farming', 'Resort'],
    country: 'Costa Rica',
    website: 'https://zunya.com/',
    coords: [9.60787412813174, -85.14182228892565],
  },
  {
    name: 'Mars College',
    description:
      'A virtual learning community focused on space exploration and technology.',
    tags: ['Education', 'Web3'],
    country: 'USA',
    website: 'https://mars.college/',
    coords: [33.35746500317858, -115.7311437807498],
  },
  {
    name: 'MOOS',
    onboardingStatus: 'live',
    ...
    coords: [52.48814882856454, 13.46054530048266],
  },
  {
    name: 'The Venus Project',
    description:
      'Designing a sustainable civilization through resource-based economy.',
  ...
  },
  {
    name: 'ReGen Villages',
    description:
      'Regenerative neighborhoods that produce their own food, energy, and water.',
    tags: ['Eco Village', 'Technology'],
    country: 'Netherlands',
  ...
  },
  {
    ...
    description:
      'A retreat center focused on humanistic alternative education.',
    tags: ['Education', 'Event Space'],
    country: 'USA',
  ...
  },
  {
    ...
    description:
      "A retreat center applying contemplative wisdom to today's pressing issues.",
    tags: ['Education', 'Event Space'],
    country: 'USA',
  ...
  },
  {
    ...
    description:
      'A learning organization focused on personal and social change.',
    tags: ['Education', 'Event Space'],
    country: 'USA',
  ...
  },
  {
    name: 'Lost Valley',
    description:
      'A non-profit taking a holistic approach to sustainability education.',
    tags: ['Eco Village', 'Education', 'Farming'],
    country: 'USA',
    website: 'https://www.lostvalley.org/',
    coords: [43.89161177911071, -122.82563390185132],
  },
  {
    name: 'Lios Labs',
    onboardingStatus: 'live',
  ...
  },
  {
    ...
    onboardingStatus: 'live',
    description:
      'A 30-person ecovillage and rural think-tank in southern Sweden.',
    tags: ['Eco Village', 'Education', 'Event Space'],
    country: 'Sweden',
  ...
  },
  {
    ...
    onboardingStatus: 'live',
    description:
      'A temple village and land regeneration project on a sacred Nile island.',
    tags: ['Eco Village', 'Education', 'Event Space', 'Resort'],
    country: 'Egypt',
    website: 'https://perauset.com/',
    coords: [24.0206849, 32.8859219],
  },
  {
    name: 'A Quinta da Large',
    description:
      'A Quinta is an intentional community located in Portugal. We are dedicated to exploring the intersection of art, ecology, and technology.',
    tags: ['Art', 'Coliving', 'Coworking', 'Farming'],
    country: 'Portugal',
    website: 'https://www.aquinta.org/',
    coords: [37.66908754911384, -8.674301842327376],
  },
  {
    name: 'Sende',
    description:
      'Mountain houses with offices and gardens where you can stay and work on your project.',
    tags: ['Coliving', 'Coworking', 'Eco Village'],
    country: 'Spain',
    website: 'https://www.sende.co/',
    coords: [42.003608666410095, -8.048602813491833],
  },
  {
    name: 'Aardehuis',
    description:
      'Aardehuis is a pioneering community that merges the principles of art, ecology, and technology.',
    tags: ['Coliving', 'Eco Village'],
    country: 'Netherlands',
    website: 'https://www.aardehuis.nl/index.php/en/',
    coords: [52.32999352004901, 6.11257358434057],
  },
  {
    name: 'Gray Area',
    description:
    ...
    coords: [37.7549350892146, -122.41833103863169],
  },
  {
    name: 'Arcosanti',
    description:
      'Arcosanti is an innovative community situated in the desert of Arizona, USA.',
    tags: ['Art', 'Coliving', 'Coworking', 'Education', 'Event Space'],
    country: 'USA',
    website: 'https://www.arcosanti.org/',
    coords: [34.342549549718704, -112.10110404565829],
  },
] as VillageMapItem[];
