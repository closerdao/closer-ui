const models = {
  ...
  event: [
    ...
    },
    {
      ...
      tab: 'general',
      description: 'Leave empty to use auto-generated slug from title',
    },
    {
      name: 'description',
      label: 'Description',
  ...
  lesson: [
    ...
    {
      name: 'isDraft',
      label: 'Is this a draft? (drafts are visible to admins only)',
      type: 'switch',
      tab: 'general',
      defaultValue: false,
    },
    ...
    // },
    {
      ...
      type: 'currency',
      placeholder: 'Enter course/lesson price (for single payment courses)',
      tab: 'general',
    },
    {
      name: 'liveSessionUrl',
      label: 'Course/lesson live session URL (for live courses/lessons)',
      type: 'text',
      placeholder: 'Enter course/lesson live session URL',
      tab: 'general',
    },
    {
      name: 'previewVideo',
...
- Plant seeds`,
  ...
  listing: [
    ...
    {
      name: 'fiatPrice',
      label: 'Daily rental rate — fiat (per night)',
      type: 'currency',
      placeholder: '10.00',
      required: true,
      tab: 'prices',
    ...
    {
      name: 'tokenPrice',
      label: 'Daily rental rate — credits or tokens (per night)',
      type: 'currency',
      placeholder: '10.00',
      required: true,
      tab: 'prices',
    ...
    {
      name: 'listingPricesHourlyNote',
      type: 'note',
      headingKey: 'listing_edit_prices_hourly_heading',
      messageKey: 'listing_edit_prices_hourly_disclaimer',
      tab: 'prices',
    },
    {
  ...
  role: [
    ...
    },
    {
      ...
      editable: true,
      type: 'text',
      placeholder: 'e.g., $15/hour, room and board, etc.',
    },
    {
      name: 'hoursPerWeek',
    ...
    },
    {
      ...
      editable: true,
      type: 'tags',
      placeholder: 'cooking, gardening, construction',
    },
    {
