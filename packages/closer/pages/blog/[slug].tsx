...
const ArticlePage = ({ article, author, error, relatedArticles }: Props) => {
  ...
  const platformName = generalConfig?.platformName || config?.PLATFORM_NAME;
  ...
  const shareUrl = SITE_URL ? `${SITE_URL}/blog/${article.slug}` : '';
    ...
    <>
      <Head>
        ...
        {SITE_URL && (
          <meta
            property="og:url"
            content={`${SITE_URL}/blog/${article.slug}`}
          />
        )}
        {fullImageUrl && (
                ...
                <>
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500">
                      {dayjs(article?.updated).format('MMMM D, YYYY')} ·{' '}
            ...
            {shareUrl && (
              <div className="flex justify-center gap-4 mt-12 pt-8 border-t border-gray-100">
                ...
                <TwitterShareButton
                  title={article?.title}
                  url={shareUrl}
                  related={twitterHandle ? [twitterHandle] : undefined}
                >
                ...
                <WhatsappShareButton title={article?.title} url={shareUrl}>
                  <div className="w-11 h-11 rounded-full border border-gray-200 hover:border-green-400 hover:bg-green-50 flex items-center justify-center transition-all duration-200">
                    <svg
                      className="w-5 h-5 text-gray-600 hover:text-green-500"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <TelegramShareButton title={article?.title} url={shareUrl}>
                  <div className="w-11 h-11 rounded-full border border-gray-200 hover:border-sky-400 hover:bg-sky-50 flex items-center justify-center transition-all duration-200">
                    <svg
                      className="w-5 h-5 text-gray-600 hover:text-sky-500"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <LinkedinShareButton title={article?.title} url={shareUrl}>
