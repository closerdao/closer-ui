...
const RoadmapPage = () => {
  const structuredData = {
    ...
    description:
      'How Closer is building the coordination infrastructure for regenerative communities—where your participation travels with you.',
    author: {
      '@type': 'Organization',
      name: 'Closer',
      url: SITE_URL,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="village network, passport system, regenerative communities, decentralized identity, community coordination, ecovillage network, trust networks, web3 governance"
        />

        <meta
          property="og:title"
          content="Where Villages Connect — Closer Roadmap"
        />
        <meta
          property="og:description"
          content="How Closer is building the coordination infrastructure for regenerative communities—where your participation travels with you."
        />
        ...
        {SITE_URL && <link rel="canonical" href={`${SITE_URL}/roadmap`} />}
      ...
      <article className="min-h-screen">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg md:text-xl leading-relaxed text-[#1d1d1f] mb-6">
                We are entering an era of radical abundance. AGI writes code.
                Fusion provides energy. Compute follows energy. The technical
                constraints that shaped the twentieth century are dissolving.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <div>
                ...
                <p className="text-[#6e6e73] leading-relaxed">
                  You can&apos;t prompt your way to genuine human connection.
                  Trust is built through time, presence, and lived experience.
              ...
              <div>
                ...
                <p className="text-[#6e6e73] leading-relaxed">
                  The planet isn&apos;t making more of it. Communities that
                  steward land well—regenerating rather than extracting—will be
                  the scarce resource of the coming decades.
                </p>
              </div>
              <div>
                <h3 className="font-serif text-2xl mb-3 text-black">
                  Coordination
                </h3>
                <p className="text-[#6e6e73] leading-relaxed">
                  The social infrastructure that allows communities to find each
                  other, share resources, and make collective decisions. This is
                  the bottleneck for regenerative transition.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 md:py-28 px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg md:text-xl leading-relaxed text-[#1d1d1f] mb-10">
                Closer v4 introduces three interconnected layers. Each can
                operate independently, but together they create something larger
            ...
            <div className="space-y-12 mt-12">
              <div className="border-l-2 border-[#5290DB] pl-8">
                ...
                <p className="text-[#6e6e73] leading-relaxed mb-4">
                  Land-based projects running Closer software: ecovillages,
                  co-living spaces, regenerative farms. Each manages its own
                  bookings, events, memberships, and governance.
                </p>
                <p className="text-[#1d1d1f]">
                  Traditional Dream Factory in Portugal is the first. There will
                  be hundreds.
                </p>
              </div>
              ...
              <div className="border-l-2 border-[#5290DB] pl-8">
                ...
                <p className="text-[#6e6e73] leading-relaxed mb-4">
                  Distributed communities that curate membership based on shared
                  values, not geography. They issue portable credentials—
                  <em>passports</em>—that travel with individuals across
                  physical nodes.
                </p>
                <p className="text-[#1d1d1f]">
                  A Nomad Farm member arriving at TDF carries reputation from
                  their home network.
                </p>
              </div>
              ...
              <div className="border-l-2 border-[#5290DB] pl-8">
                ...
                <p className="text-[#6e6e73] leading-relaxed mb-4">
                  ...
                  <code className="text-sm bg-[#f5f5f7] px-2 py-1 rounded">
                    api.closer.earth
                  </code>{' '}
                  is the first hub—it coordinates passport lookups, syncs
                  credentials across communities, and enables cross-network
                  discovery.
                </p>
                <p className="text-[#1d1d1f]">
                  But the architecture is federated: any community can become a
                  hub. The protocol is the product, not the server.
                </p>
              </div>
              ...
              <div className="border-l-2 border-[#5290DB] pl-8">
                ...
                <p className="text-[#6e6e73] leading-relaxed mb-4">
                  Each community can run an AI agent that serves as its
                  collective memory—ingesting governance documents, meeting
                  transcripts, and community knowledge.
                </p>
                <p className="text-[#1d1d1f]">
                  These agents don&apos;t replace human governance. They make it
                  more accessible.
                </p>
              </div>
            </div>
        ...
        <section className="py-20 md:py-28 px-6 bg-[#fafafa]">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg md:text-xl leading-relaxed text-[#1d1d1f] mb-10">
                The passport is the portable identity layer that travels with
                you across the Closer network. It carries your credentials,
                reputation, and access rights from community to community.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 mt-10">
              <div className="bg-white p-6 rounded-xl">
                ...
                <p className="text-sm text-[#6e6e73]">
                  Citizenships, memberships, skills, attestations from trusted
                  networks
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl">
                ...
                <p className="text-sm text-[#6e6e73]">
                  Verified stays across communities—proof you were actually
                  there
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl">
                ...
                <p className="text-sm text-[#6e6e73]">
                  Nights stayed, contributions made, vouches received—real
                  primitives, not abstract scores
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl">
                <h4 className="font-medium mb-2 text-black">Sweat Equity</h4>
                <p className="text-sm text-[#6e6e73]">
                  Hours contributed, skills offered—proof of work for the
                  commons
                </p>
              </div>
            </div>
            ...
            <div className="mt-12 p-8 border border-[#5290DB] rounded-xl bg-[#5290DB]/5">
              <h4 className="font-serif text-xl mb-3 text-black">
                Privacy by Design
              </h4>
              <p className="text-[#6e6e73] leading-relaxed">
                Your data is yours. Email addresses are hashed before any
                cross-server queries. Data sharing between servers is opt-in
                only. You control what other communities can see about you.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="relative">
              ...
              {phases.map((phase, index) => (
                <div key={index} className="relative pl-10 md:pl-14 pb-12">
                  <div
                    className={`absolute left-0 md:left-1 w-6 h-6 md:w-7 md:h-7 rounded-full border-2 ${
                  ...
                  <div>
                    <div className="flex items-baseline gap-4 mb-3">
                      ...
                      {phase.status === 'current' && (
                        <span className="text-xs text-[#5290DB] uppercase tracking-wide">
                          Now
                        </span>
                      )}
                    </div>
                    ...
                    <ul className="space-y-2">
                      {phase.items.map((item, i) => (
                        <li
                          key={i}
                          className="text-[#6e6e73] flex items-start gap-3"
                        >
              ...
              {milestones.map((milestone, index) => (
                ...
                >
                  <div className="grid md:grid-cols-[140px_1fr] gap-6 md:gap-12">
                    <div>
                      <p className="font-serif text-5xl md:text-6xl text-[#5290DB]">
                        {milestone.year}
                      </p>
                    </div>
                    <div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-12">
              <div>
                ...
                <p className="text-[#6e6e73] leading-relaxed">
                  Villages don&apos;t pay rent to a platform. They run their own
                  nodes. If{' '}
                  <code className="text-sm bg-[#f5f5f7] px-2 py-1 rounded">
                    api.closer.earth
                  </code>{' '}
                  disappeared tomorrow, communities would still
                  function—they&apos;d just lose cross-network discovery until
                  another hub emerged.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-[#6e6e73] leading-relaxed">
                  The passport system creates a trust graph—who has stayed
                  where, who vouches for whom, which networks have agreements
                  with which spaces. This graph can&apos;t be copied by a
                  competitor because it&apos;s built through lived experience
              ...
              <div>
                ...
                <p className="text-[#6e6e73] leading-relaxed">
                  More villages in the network means more places your passport
                  works, which means more value in holding credentials. But any
                  community can fork, run their own hub, or leave. The network
                  effects come from coordination value, not switching costs.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-12 px-6 border-t border-[#e5e5e7]">
          <div className="max-w-3xl mx-auto">
            <p className="text-sm text-[#6e6e73] leading-relaxed">
              <strong className="text-[#1d1d1f]">On governance tokens:</strong>{' '}
              As the federation grows, launching a $CLOSER governance token
              could become a path for coordinating network-wide decisions and
              funding commons infrastructure. This remains a future
              consideration, not a current commitment.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 md:py-28 px-6 bg-[#1d1d1f] text-white">
          <div className="max-w-3xl mx-auto text-center">
            <p className="font-serif text-2xl md:text-3xl leading-relaxed mb-12">
              This isn&apos;t a pitch for a startup. It&apos;s an invitation to
              build the commons together.
            </p>
            <p className="text-white/60 mb-12">
              AGI writes the code. Humans govern the trust. Physical places
              connected by digital commons.
            </p>
