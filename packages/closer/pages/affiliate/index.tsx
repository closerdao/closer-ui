...
const AffiliateDashboard = ({
  ...
  const revenueStats = useMemo(
    ...
    [referralCharges, affiliateConfig],
  );
  ...
  }, [platform, filters.referralsFilter, filters.referralChargesFilter]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-8">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <StatsCard
            ...
            value={`€${
              revenueStats.tokenSaleRevenue + revenueStats.financedTokenRevenue
            }`}
        ...
        <Card>
          ...
          <div>
            ...
            <p>€{revenueStats.staysRevenue.toFixed(2)}</p>
          </div>
          <div>
            <p className="font-bold">
            ...
            <p>€{revenueStats.eventsRevenue.toFixed(2)}</p>
          </div>
          <div>
            <p className="font-bold">
            ...
            <p>€{revenueStats.subscriptionsRevenue.toFixed(2)}</p>
          </div>
          <div>
            <p className="font-bold">
            ...
            <p>€{revenueStats.tokenSaleRevenue.toFixed(2)}</p>
          </div>
          <div>
            <p className="font-bold">
            ...
            <p>€{revenueStats.financedTokenRevenue.toFixed(2)}</p>
          </div>
        </Card>
      </div>
    </>
