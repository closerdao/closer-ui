...
const CitizenshipPage = ({
  ...
  const faqs = [
    {
      question: t('citizenship_faq_tokens_needed_q'),
      answer: t('citizenship_faq_tokens_needed_a'),
    },
    {
      question: t('citizenship_faq_portugal_q'),
      answer: t('citizenship_faq_portugal_a'),
    },
    {
      question: t('citizenship_faq_land_stewardship_q'),
      answer: t('citizenship_faq_land_stewardship_a'),
    },
    {
      question: t('citizenship_faq_resell_q'),
      answer: t('citizenship_faq_resell_a'),
    },
    {
      question: t('citizenship_faq_responsibilities_q'),
      answer: t('citizenship_faq_responsibilities_a'),
    },
  ];
  ...
  const meta = resolvePageMeta(pageMeta, {
    title: heroTitle,
    description: t('citizenship_page_meta_description'),
  ...
  return (
    <div className="min-h-screen bg-neutral-light text-foreground">
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-6xl px-6 py-14">
          <CollapsibleFaq title={t('citizenship_faq_title')} items={faqs} />
...
CitizenshipPage.getInitialProps = async (_context: NextPageContext) => {
  const pageMeta = await fetchPageMetaOverride('/citizenship');
  return { pageMeta };
};
