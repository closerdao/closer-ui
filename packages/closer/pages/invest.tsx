...
const PackageCard = ({
    ...
    : isLoan
      ...
      : isCredits && credits
        ...
        : isSubscribe
          ...
          : '#';
  const href = (pkg.ctaUrl && pkg.ctaUrl.trim() !== '') ? pkg.ctaUrl : defaultHref;
  ...
  return (
    ...
    >
      ...
      <LinkButton
        href={href}
        target={isLoan || (pkg.ctaUrl && href.startsWith('http')) ? '_blank' : undefined}
  ...
  return (
    <>
      <Head>
        ...
        {opts.shareUrl && (
          <meta property="og:url" content={opts.shareUrl} />
        )}
        <meta
          property="og:title"
                    ...
                    {milestones.map((milestone, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {milestone.ctaUrl && milestone.ctaUrl.trim() !== '' && (
                            <div className="mt-3">
                              <LinkButton
