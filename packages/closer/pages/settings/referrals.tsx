  ...
  return (
    <>
      ...
      <div className="max-w-screen-sm mx-auto md:p-8 h-full main-content w-full flex flex-col gap-14  min-h-screen py-2">
        ...
        <div>
          <p className="mb-4">
            {APP_NAME && t('referrals_description_text_1')}
          </p>
          <p className="mb-4">
            {APP_NAME && t('referrals_description_text_2')}
          </p>
          <p className="mb-4">
            {APP_NAME && t('referrals_description_text_3')}
          </p>
          <p className="mb-4 text-accent font-bold">
            <Link href="/settings/credits">
              {APP_NAME && t('referrals_credits_link')}
            </Link>
          </p>
        </div>
        <Heading level={3} hasBorder={true}>
