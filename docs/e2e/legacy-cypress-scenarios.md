...
- **Gap flagged:** this scenario is incomplete as a "paid with credits"
  ...
  credits-checkout ticket; nothing under [#627 📋](https://github.com/closerdao/closer-procurement/issues/627) currently owns "pay with
  credits" explicitly.
...
- **Mapping:** same as Scenario 4 —
  ...
  worth confirming hourly is in scope for [#630 📋](https://github.com/closerdao/closer-procurement/issues/630) or needs its own follow-up).
...
| 2   | Unauth nightly booking → signup/login redirect             | No dedicated ticket; related to [#629 📋](https://github.com/closerdao/closer-procurement/issues/629)                                                                                                                                                                                      |
...
| 7   | Unauth listing search → login mid-flow → summary           | Same as scenario 6                                                                                                                                                                                                                                                                         |
| 8   | Hourly listing, full paid checkout                         | Same as scenario 4, hourly scope unconfirmed                                                                                                                                                                                                                                               |
| 9   | Unauth hourly booking redirect (author-flagged as thin)    | Related to [#629 📋](https://github.com/closerdao/closer-procurement/issues/629); needs real rewrite, not a straight port                                                                                                                                                                  |
